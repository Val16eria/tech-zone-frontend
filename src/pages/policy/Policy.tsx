		...
		<div className="policy flex-column custom-container">
			...
			<ol className="policy__content policy__content_points flex-column">
				<li className="policy__points_point policy__points_point-title">
					Общие положения
					<ol className="policy__content policy__content_sub-points flex-column">
						<li className="policy__points_point-txt">
							...
							предпринимаемые TechZone (далее — Оператор).
						</li>
				...
				<li className="policy__points_point policy__points_point-title">
					...
					<ol className="policy__content policy__content_sub-points flex-column">
						...
						<li className="policy__points_point policy__points_point-txt">
							...
							для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные,
				...
				<li className="policy__points_point policy__points_point-title">
					...
					<ol className="policy__content policy__content_sub-points flex-column">
						<li className="policy__points_point policy__points_point-txt">
							...
							<ul className="policy__content_sub-points flex-column">
								<li className="policy__points_list policy__points_point-txt">
				...
				<li className="policy__points_point policy__points_point-title">
					...
					<ol className="policy__content policy__content_sub-points flex-column">
						<li className="policy__points_point policy__points_point-txt">
							...
							<ul className="policy__content_sub-points flex-column">
								<li className="policy__points_list policy__points_point-txt">
									...
									Сведения предоставляются субъекту персональных данных Оператором в доступной форме,
						...
						<li className="policy__points_point policy__points_point-txt">
							...
							либо сведения о другом субъекте персональных данных без согласия последнего,
				...
				<li className="policy__points_point policy__points_point-title">
					...
					<ol className="policy__content policy__content_sub-points flex-column">
						...
						<li className="policy__points_point policy__points_point-txt">
							...
							Обрабатываемые персональные данные уничтожаются либо обезличиваются по достижении целей обработки или
